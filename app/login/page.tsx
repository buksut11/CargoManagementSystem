          ...
          <form onSubmit={signIn} className="space-y-4">
            <Field label="Email">
              <span className="relative block">
                <span className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-slate-600 dark:text-slate-500 [&_svg]:h-4.5 [&_svg]:w-4.5">
                  <MailIcon />
                </span>
                <input
                  type="email"
            ...
            <Field label="Password">
              <span className="relative block">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-600 transition-colors hover:text-slate-800 dark:text-slate-500 dark:hover:text-slate-300 [&_svg]:h-4.5 [&_svg]:w-4.5"
                >

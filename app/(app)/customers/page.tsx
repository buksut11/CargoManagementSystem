...
import { fetchCargoCustomerBalances } from "@/lib/balance";
...
// Filled-tint action pill used only on this page, so the styling stays
// contained to the Customers list and no other table is affected.

...
-- Remove the generic catch-all, plus earlier "🧳 Porter" / "🚌 Sahal" labels
-- if they were already added. Any existing expense row that used one of these
-- keeps its stored label — it just stops being offered as a new choice.
delete from public.expense_categories where name in ('📦 Other', '🧳 Porter', '🚌 Sahal');
